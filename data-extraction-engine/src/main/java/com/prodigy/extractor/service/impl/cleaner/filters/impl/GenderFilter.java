...
public class GenderFilter implements Filter<DataExtractionRequest> {

    @Override public boolean filter (DataExtractionRequest data) {
        return StringUtils.isEmpty(data.getGender()) ;
    }

    @Override public void clean (DataExtractionRequest data) { data.setGender(null); }
